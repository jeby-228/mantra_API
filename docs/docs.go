    ...
    "paths": {
        "/auth/line": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "LINE 登入信息",
                        "name": "lineLogin",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.LineLoginRequest"
                        }
                    }
                ],
                "responses": {
